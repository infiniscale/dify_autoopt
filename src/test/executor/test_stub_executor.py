...
class TestStubExecutorIntegration:
    ...
    def test_stub_executor_with_mixed_behaviors(
        ...
        tasks = [
            Task.from_manifest_case(sample_test_case, sample_manifest.execution_policy, "wf_001", mock_id_fn, mock_now_fn)
            for _ in range(5)
        ]
    ...
    def test_stub_executor_with_retry_on_failure(
        ...
        task = Task.from_manifest_case(sample_test_case, sample_manifest.execution_policy, "wf_001", mock_id_fn, mock_now_fn)
